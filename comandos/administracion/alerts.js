 ...
 * name: alerts
 * aliases: ["alertas"]
 * description: Activa/desactiva alertas de promote/demote
...
export async function run(ctx) {
  ...
  if (!['enable','disable'].includes(v)) {
    return sock.sendMessage(gid, { text: '✨ Usa: $alerts enable | disable' }, { quoted: msg })
  }
  groups[gid].alerts = v === 'enable'
  await saveGroups(GROUPS_FILE, db, groups)
  await sock.sendMessage(gid, { text: '🎀 ¡Listo! Configuración de alertas actualizada 💖' }, { quoted: msg })
}
