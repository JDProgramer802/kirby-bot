 ...
 * name: antilink
 * aliases: ["antienlace"]
 * description: Activa/desactiva detección de enlaces
...
export async function run(ctx) {
  ...
  if (!['enable','disable'].includes(v)) return sock.sendMessage(gid,{text:'✨ Usa: $antilink enable | disable'},{quoted:msg})
  groups[gid].antilink = v === 'enable'
  await saveGroups(GROUPS_FILE, db, groups)
  await sock.sendMessage(gid, { text: '🎀 ¡Listo! Antilink actualizado 💖' }, { quoted: msg })
}
