 ...
 * name: setbotcurrency
 * aliases: []
 * description: Cambia la moneda del bot
 * category: Bot
 */
...
export async function run(ctx){
  ...
  if (!name) return sock.sendMessage(msg.key.remoteJid,{ text:'✨ Usa: $setbotcurrency [nombre]'},{ quoted: msg })
  cfg.currency = name
  await db.saveJSON(CONFIG_FILE, cfg)
  await sock.sendMessage(msg.key.remoteJid,{ text:`🎀 Moneda actualizada a ${name}`},{ quoted: msg })
}
