/**
 * name: packfavourite
 * aliases: ["setpackfav","packfav"]
 * description: Marca un pack como favorito
 * category: Stickers
 */
...
export async function run(ctx){
  ...
  if(!pack) return sock.sendMessage(gid,{ text:'✨ Usa: $packfavourite <pack>'},{ quoted: msg })
  ...
  usr.favouritePack = pack
  await saveRoot(files, db, root)
  await sock.sendMessage(gid,{ text:`💖 Pack favorito: ${pack} 🎀`},{ quoted: msg })
}
